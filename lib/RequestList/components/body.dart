            ...
            Stack(
              children: [
                Positioned(
                  top: 10,right: 15,
                  child: InkWell(
                    child: FaIcon(FontAwesomeIcons.signOutAlt,color: whiteTextColor,),onTap: () {
                    SharedPreferences.getInstance().then((value) {
                      value.remove("token");
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Padding(
                              ...
                              child: Text("Restaurant Request", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold, color: Colors.white),),
                            ),
                          ],
                        ),
                      )
                ...
                children: <Widget>[
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) =>
                      ...
                      press: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => NewStores(widget.roleId),),);//StoreList(requestList[index]['id'],widget.roleId),),);
                      },
                    ),
                  )
                ],
