...
class AdminNavBar extends StatefulWidget {
 var storeId,roleId;
  ...
  AdminNavBar(this.storeId,this.roleId);
...
//      ),
  ...
  _getPage(int page) {
    switch (page) {
      ...
      case 1:
        return categoryListPage(widget.storeId,widget.roleId);
      case 2:
        return FoodDelivery(widget.storeId,widget.roleId);
      case 3:
        return OrderRecordTabsScreen(widget.storeId,widget.roleId);
      default:
