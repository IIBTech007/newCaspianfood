          ...
          Stack(
            children: [
              Positioned(
                  top: 10,right: 15,
                  child: InkWell(
                      child: FaIcon(FontAwesomeIcons.signOutAlt,color: PrimaryColor,),onTap: () {
                    SharedPreferences.getInstance().then((value) {
                      value.remove("token");
              ...
              children: <Widget>[
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) => ProductCard(
                    ...
                    press: () {
                      print(requestList[index]['id'].toString());
                      if(requestList[index]['statusId'] == 1){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => NewStores( widget.roleId),),);
