...
class _LocationScreenState extends State<LocationScreen> {
  ...
  static const LatLng _center = const LatLng(32.561745, 74.081196);
                                                    ...
                                                    children: <Widget>[
                                                      Row(
                                                        children: <Widget>[
                                                          ...
                                                          Text("0335 4643137",style: TextStyle(color: Color(0xFF172a3a),fontSize: 20,fontWeight: FontWeight.bold),),
                                                        ],
                                                      ),
                                                      //Text("(2.9 Miles)",style: TextStyle(color: Colors.blue,fontSize: 20,fontWeight: FontWeight.bold),),
                                                      //FaIcon(FontAwesomeIcons.angleRight, color: Colors.blue, size: 30,),
