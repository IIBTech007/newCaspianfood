...
import 'package:capsianfood/screens/CutomerPannel/About&MapScreens/AboutScreen.dart';
...
//  FirebaseMessaging _firebaseMessaging;
    ...
    return Scaffold(
      ...
      bottomNavigationBar: FancyBottomNavigation(
        tabs: [
          TabData(
            iconData:Icons.home,
            title: translate('Home_screen.bottomTitle1'),
          ),
          TabData(
            iconData: Icons.shopping_cart,
            title: translate('Home_screen.bottomTitle2'),
          ),

          TabData(iconData: Icons.shopping_basket, title: translate('Home_screen.bottomTitle3'),),
          TabData(iconData: FontAwesomeIcons.infoCircle, title: "About",),
  ...
  _getPage(int page) {
    switch (page) {
      case 0:
       return HomePage(1);// return NewHomePage();
      case 1:
        return MyCartScreen();
      case 2:
